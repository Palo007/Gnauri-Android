...
const onMassEditReqRe = /graph\.onMassEditRequest = \(t1, t2, y1, y2, view\) => \{([\s\S]*?)\$("massEditApply").onclick/;
const oldMassEdit = html.match(onMassEditReqRe)[0];
...
html = html.replace(oldMassEdit, newMassEditVoice);
